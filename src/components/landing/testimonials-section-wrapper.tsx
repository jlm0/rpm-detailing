...
async function getTestimonialsSectionProps(): Promise<ComponentProps<typeof TestimonialsSection>> {
  try {
...
async function TestimonialsSectionData() {
  const props = await getTestimonialsSectionProps()
  return <TestimonialsSection {...props} />
}

function TestimonialsSectionLoading() {
  return (
    <div className="flex items-center justify-center bg-brandLightGray py-20">
