...
export const defaultServices = [
  {
    ...
    description: "Our essential detailing service includes hand wash, interior vacuum, window cleaning, and tire dressing. Perfect for regular maintenance.",
    features: [
  ...
  },
  {
    ...
    description: "Our comprehensive detailing service includes everything in the basic package plus clay bar treatment, wax application, and leather conditioning.",
    features: [
  ...
  },
  {
    ...
    description: "Our ultimate detailing experience includes paint correction, ceramic coating, and complete interior restoration. The best protection for your vehicle.",
    features: [
